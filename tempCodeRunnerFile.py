...
app_image = Label(left_frame, height=130, image=img_1, bg=co1)
app_image.place(x=15, y=15)

img_3 = Image.open('icons/back.png')
img_3 = img_3.resize((30, 30))
img_3 = ImageTk.PhotoImage(img_3)
prev_button = Button(down_frame, width=40, height=40, image=img_3, bg=co1, font=("Ivy 10"), command=prev_music)
prev_button.place(x=0, y=35)

img_2 = Image.open('icons/play.png')
img_2 = img_2.resize((30, 30))
img_2 = ImageTk.PhotoImage(img_2)
play_button = Button(down_frame, width=40, height=40, image=img_2, bg=co1, font=("Ivy 10"), command=play_music)
play_button.place(x=46, y=35)

img_4 = Image.open('icons/forward.png')
img_4 = img_4.resize((30, 30))
img_4 = ImageTk.PhotoImage(img_4)
next_button = Button(down_frame, width=40, height=40, image=img_4, bg=co1, font=("Ivy 10"), command=next_music)
next_button.place(x=92, y=35)

img_5 = Image.open('icons/pause.png')
img_5 = img_5.resize((30, 30))
img_5 = ImageTk.PhotoImage(img_5)
pause_button = Button(down_frame, width=40, height=40, image=img_5, bg=co1, font=("Ivy 10"), command=pause_music)
pause_button.place(x=138, y=35)

img_6 = Image.open('icons/resume.png')
img_6 = img_6.resize((30, 30))
img_6 = ImageTk.PhotoImage(img_6)
resume_button = Button(down_frame, width=40, height=40, image=img_6, bg=co1, font=("Ivy 10"), command=resume_music)
resume_button.place(x=184, y=35)

img_7 = Image.open('icons/stop.png')
img_7 = img_7.resize((30, 30))
img_7 = ImageTk.PhotoImage(img_7)
stop_button = Button(down_frame, width=40, height=40, image=img_7, bg=co1, font=("Ivy 10"), command=stop_music)
stop_button.place(x=230, y=35)

# Add music button
img_8 = Image.open('icons/addsong.png')
img_8 = img_8.resize((30, 30))
img_8 = ImageTk.PhotoImage(img_8)
add_music_button = Button(down_frame, image=img_8, width=40, height=40, bg=co1, font=("Ivy 10"), command=add_music)
add_music_button.place(x=276, y=35)

# Delete music button
img_9 = Image.open('icons/deletesong.png')
img_9 = img_9.resize((30, 30))
img_9 = ImageTk.PhotoImage(img_9)
delete_music_button = Button(down_frame, image=img_9, width=40, height=40, bg=co1, font=("Ivy 10"), command=delete_music)
delete_music_button.place(x=322, y=35)

# Add to favorite button
img_10 = Image.open('icons/favorite.png')
img_10 = img_10.resize((30, 30))
img_10 = ImageTk.PhotoImage(img_10)
favorite_button = Button(down_frame, image=img_10, width=40, height=40, bg=co1, font=("Ivy 10"), command=add_favorite)
favorite_button.place(x=368, y=35)
...
# Running song label
running_song = Label(down_frame, text="Choose a Song", font=("Ivy 10"), width=44, height=1, padx=10, bg=co1, fg=co5, anchor=NW)
